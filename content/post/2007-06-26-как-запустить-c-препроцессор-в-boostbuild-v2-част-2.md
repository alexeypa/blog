...
> [В таком виде генератор уже пригоден к использованию, однако его можно сделать ещё лучше. Как - читайте в следующей части.]({{< relref "2007-06-12-как-запустить-c-препроцессор-в-boostbuild-v2-част.md" >}})
