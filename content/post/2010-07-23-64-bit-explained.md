...
Для всего этого счастья есть [логичное объяснение]({{< relref "post/2007-06-27-почему-wow64-использет-перенаправление-р.md" >}}), сдобренное обычным "ну здесь мы применили маленький хак". Но от этого не сильно легче.
